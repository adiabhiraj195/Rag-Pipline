...
// Document routes (List, details, content preview, download URL, deletion)
...
app.listen(PORT, () => {
  ...
  console.log(`[Server] Documents endpoints: GET http://localhost:${PORT}/documents, GET /documents/:id, GET /documents/:id/content, GET /documents/:id/view-url`);
